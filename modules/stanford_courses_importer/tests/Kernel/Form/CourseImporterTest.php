 ...
 *
 * @covers \Drupal\stanford_courses_importer\Form\CourseImporter
...
class CourseImporterTest extends HsCoursesImporterTestBase implements ServiceModifierInterface {
   ...
   * @var string
   */
  protected $formClass = '\Drupal\stanford_courses_importer\Form\CourseImporter';
  ...
  public function testForm() {
    ...
    $config_urls = $this->config('stanford_courses_importer.importer_settings')
      ->get('urls');
