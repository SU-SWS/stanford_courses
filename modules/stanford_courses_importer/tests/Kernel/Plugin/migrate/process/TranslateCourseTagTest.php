...
namespace Drupal\Tests\stanford_courses_importer\Kernel\Plugin\migrare\process;
 ...
 *
 * @covers \Drupal\stanford_courses_importer\Plugin\migrate\process\TranslateCourseTag
...
class TranslateCourseTagTest extends EntityKernelTestBase {
   ...
   *
   * @var \Drupal\stanford_courses_importer\Plugin\migrate\process\TranslateCourseTag
   */
  ...
  public function testTranslateTag() {
    /** @var \Drupal\stanford_courses_importer\Plugin\migrate\process\TranslateCourseTag $translate_plugin */
